...
<list type="none">
    <li>
        <list type="bullet">
            ...
            <li>
                Deve possuir sistemas de controle e moderação ativa, incluindo filtros de linguagem inadequada, palavras ofensivas e comportamento tóxico. O(a) dono(a) do servidor é totalmente responsável pelo ambiente da sua comunidade.
            </li>
        </list>
    </li>
</list>
...
<list type="none">
    <li>
        <list type="bullet">
            ...
            <li>
                Uma proposta robusta de benefícios;
            </li>
            <li>
