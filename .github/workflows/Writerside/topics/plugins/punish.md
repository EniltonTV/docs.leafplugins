...
<chapter title="Clique aqui" collapsible="true">
    <deflist>
        <def title="Configurando aplicação webhooks">
            <p>Abaixo você aprenderá a como configurar aplicações webhooks para o LeafPunish.</p>
            <video src="https://youtu.be/pyp0cnNDbjA"/>
        </def>
    </deflist>
    <deflist>
        <def title="Configurando servidor de banimentos">
            <p>Abaixo você aprenderá a como configurar o servidor de banimentos usando o LeafPunish.</p>
            <video src="https://youtu.be/O_q286HLH5Q"/>
        </def>
    </deflist>
</chapter>
